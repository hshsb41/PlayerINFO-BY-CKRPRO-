...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "ME":
        return "uid=4337844075&password=CKR_19R9M__V0DZU"
    elif r == "BD":
        return "uid=4337844075&password=CKR_19R9M__V0DZU"
...
async def get_account_info():
    ...
    try:
        ...
        return jsonify({"error": "Invalid UID or server error. Please try again.created by ckrpro YouTube : ckr unknown TikTok : ckr unknown"}), 500
